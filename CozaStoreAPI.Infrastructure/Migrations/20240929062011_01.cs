    ...
    public partial class _01 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("19504380-d57b-42ab-af3b-71cbc9132efb"), 0, "da952e38-451e-4c6f-90f3-aa2690e52f01", "test@test.com", true, "TestFirstName", "TestLastName", false, null, "TEST@TEST.COM", "TEST@TEST.COM", "AQAAAAIAAYagAAAAECzr6UDd/fCdOGl1s8KC9k0vRarG2gXccUMvIg5VXO0EjP4KrxJrZ1jp1dVMnWIoug==", "0888 888 888", false, "NNC2KI3MK4ONPNJIS5HUOKHN3565MBID", "", "", false, "test@test.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(260), new TimeSpan(0, 3, 0, 0, 0)), "Description of product Esprit Ruffle Shirt", false, "60% cotton, 40% polyester", "Esprit Ruffle Shirt", 16.64m, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(317), new TimeSpan(0, 3, 0, 0, 0)) },
                    { 2, 1, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(327), new TimeSpan(0, 3, 0, 0, 0)), "Description of product Herschel supply", false, "60% cotton, 40% polyester", "Herschel supply", 35.31m, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(330), new TimeSpan(0, 3, 0, 0, 0)) },
                    { 3, 2, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(335), new TimeSpan(0, 3, 0, 0, 0)), "Description of product Only Check Trouser", false, "60% cotton, 40% polyester", "Only Check Trouser", 25.50m, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(337), new TimeSpan(0, 3, 0, 0, 0)) },
                    { 4, 1, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(342), new TimeSpan(0, 3, 0, 0, 0)), "Description of product Classic Trench Coat", false, "60% cotton, 40% polyester", "Classic Trench Coat", 75.00m, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(344), new TimeSpan(0, 3, 0, 0, 0)) },
                    { 5, 1, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(348), new TimeSpan(0, 3, 0, 0, 0)), "Description of product Front Pocket Jumper", false, "60% cotton, 40% polyester", "Front Pocket Jumper", 34.75m, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(351), new TimeSpan(0, 3, 0, 0, 0)) },
                    { 6, 4, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(357), new TimeSpan(0, 3, 0, 0, 0)), "Description of product Vintage Inspired Classic", false, "", "Vintage Inspired Classic", 93.20m, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(359), new TimeSpan(0, 3, 0, 0, 0)) },
                    { 7, 1, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(364), new TimeSpan(0, 3, 0, 0, 0)), "Description of product Shirt in Stretch Cotton", false, "60% cotton, 40% polyester", "Shirt in Stretch Cotton", 52.66m, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(366), new TimeSpan(0, 3, 0, 0, 0)) },
                    { 8, 1, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(370), new TimeSpan(0, 3, 0, 0, 0)), "Description of product Pieces Metallic Printed", false, "60% cotton, 40% polyester", "Pieces Metallic Printed", 18.96m, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(373), new TimeSpan(0, 3, 0, 0, 0)) },
                    { 9, 3, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(377), new TimeSpan(0, 3, 0, 0, 0)), "Description of product Converse All Star Hi Plimsolls", false, "60% cotton, 40% polyester", "Converse All Star Hi Plimsolls", 75.00m, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(379), new TimeSpan(0, 3, 0, 0, 0)) },
                    { 10, 1, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(384), new TimeSpan(0, 3, 0, 0, 0)), "Description of product Femme T-Shirt In Stripe", false, "60% cotton, 40% polyester", "Femme T-Shirt In Stripe", 25.85m, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(386), new TimeSpan(0, 3, 0, 0, 0)) },
                    { 11, 2, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(391), new TimeSpan(0, 3, 0, 0, 0)), "Description of product Herschel supply", false, "60% cotton, 40% polyester", "Herschel supply", 63.16m, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(393), new TimeSpan(0, 3, 0, 0, 0)) },
                    { 12, 2, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(397), new TimeSpan(0, 3, 0, 0, 0)), "Description of product Herschel supply", false, "100% leather", "Herschel supply", 63.15m, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(400), new TimeSpan(0, 3, 0, 0, 0)) },
                    { 13, 1, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(404), new TimeSpan(0, 3, 0, 0, 0)), "Description of product T-Shirt with Sleeve", false, "60% cotton, 40% polyester", "T-Shirt with Sleeve", 18.49m, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(406), new TimeSpan(0, 3, 0, 0, 0)) },
                    { 14, 1, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(410), new TimeSpan(0, 3, 0, 0, 0)), "Description of product Pretty Little Thing", false, "60% cotton, 40% polyester", "Pretty Little Thing", 54.79m, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(413), new TimeSpan(0, 3, 0, 0, 0)) },
                    { 15, 4, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(418), new TimeSpan(0, 3, 0, 0, 0)), "Description of product Mini Silver Mesh Watch", false, "", "Mini Silver Mesh Watch", 86.85m, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(420), new TimeSpan(0, 3, 0, 0, 0)) },
                    { 16, 1, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(425), new TimeSpan(0, 3, 0, 0, 0)), "Description of product Square Neck Back", false, "60% cotton, 40% polyester", "Square Neck Back", 29.64m, new DateTimeOffset(new DateTime(2024, 9, 29, 9, 20, 10, 278, DateTimeKind.Unspecified).AddTicks(427), new TimeSpan(0, 3, 0, 0, 0)) }
                });
